...
{
    [CustomEditor(typeof(HeathensSteamworksInstallSettingsFoundation))]
    public class HeathensSteamworksInstallSettingsFoundationEditor : Editor
    {
        private HeathensSteamworksInstallSettingsFoundation pSettings;

        public override void OnInspectorGUI()
        {
            pSettings = target as HeathensSteamworksInstallSettingsFoundation;
            ...
            else
            {
                if (pSettings.SteamworksNetFound)
                {
                    ...
                    if (pSettings.HeathenSteamworksFoundation == null)
                    {
                        EditorGUILayout.HelpBox("You must reference the HeathenSystemsSteamworksFoundation_Install Unity Package before this tool can be used to install it.", MessageType.Error);
                    }
                    else
                    {
