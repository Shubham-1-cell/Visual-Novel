...
namespace HeathenEngineering.SteamTools
{
    ...
    {
        [MenuItem("Steamworks/Tools/Heathen's Steamworks Foundation Installation")]
        private static void HeathensSteamworksInstallSettings()
        {
            var results = AssetDatabase.FindAssets("t:HeathensSteamworksInstallSettingsFoundation");
            if (results.Length > 0)
            {
