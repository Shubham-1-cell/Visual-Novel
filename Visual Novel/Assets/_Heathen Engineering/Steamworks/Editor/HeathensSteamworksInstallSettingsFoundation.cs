...
namespace HeathenEngineering.SteamTools
{
    ...
    [CreateAssetMenu(menuName = "Steamworks/Foundation Installer Settings")]
    public class HeathensSteamworksInstallSettingsFoundation : ScriptableObject
    {
#if UNITY_EDITOR
        public Object SteamworksInstall;
        public Object HeathenSteamworksFoundation; 
        [HideInInspector]
        ...
        public void InstallHeathenSteamworksPackage()
        {
            ...
            if (SteamworksInstall != null)
            {
                ...
                string steamworksPackage = UnityEditor.AssetDatabase.GetAssetPath(HeathenSteamworksFoundation);
                UnityEditor.AssetDatabase.ImportPackage(steamworksPackage, true);
            }
            else
            {
